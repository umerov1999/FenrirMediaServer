...
//Sets "initializingdata" attribute of section
section& section::initializingdata(bool initializingdata)
{
	return set_flag(image_scn_cnt_initialized_data, initializingdata);
}

//Sets "uninitializingdata" attribute of section
section& section::uninitializingdata(bool uninitializingdata)
{
	return set_flag(image_scn_cnt_uninitialized_data, uninitializingdata);
}
...
//Sets "reloc" attribute of section
section& section::extended_relocation(bool extended_relocation)
{
	return set_flag(image_scn_lnk_nreloc_ovfl, extended_relocation);
}

//Sets "not_cached" attribute of section
section& section::not_cached(bool not_cached)
{
	return set_flag(image_scn_mem_not_cached, not_cached);
}

//Sets "not_paged" attribute of section
section& section::not_paged(bool not_paged)
{
	return set_flag(image_scn_mem_not_paged, not_paged);
}
...
bool section::initializingdata() const
{
	return (header_.Characteristics & image_scn_cnt_initialized_data) != 0;
}

bool section::uninitializingdata() const
{
...
bool section::extended_relocation() const
{
	return (header_.Characteristics & image_scn_lnk_nreloc_ovfl) != 0;
}

bool section::not_cached() const
{
	return (header_.Characteristics & image_scn_mem_not_cached) != 0;
}

bool section::not_paged() const
{
	return (header_.Characteristics & image_scn_mem_not_paged) != 0;
}
