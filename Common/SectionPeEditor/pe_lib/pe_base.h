...
public: //CONSTRUCTORS
	...
	pe_base(std::istream& file, const pe_properties& props, bool read_debug_raw_data = false);
...
public: //DIRECTORIES
	...
	void get_advanced_pe_version(uint16_t &MajorImageVersion, uint16_t &MinorImageVersion, uint32_t &Win32VersionValue, uint16_t &Subsystem) const;
...
public: //IMAGE SECTIONS
	...
	bool SectionExist(char* sectnm);
	section& find_section_by_name(char* name);
	const section& find_section_by_name(char* name) const;
