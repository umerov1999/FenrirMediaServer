...
template<typename PEClassType>
void pe_properties_generic<PEClassType>::get_advanced_pe_version(uint16_t &MajorImageVersion, uint16_t &MinorImageVersion, uint32_t &Win32VersionValue, uint16_t &Subsystem) const
{
	MajorImageVersion = nt_headers_.OptionalHeader.MajorImageVersion;
	MinorImageVersion = nt_headers_.OptionalHeader.MinorImageVersion;
	Win32VersionValue = nt_headers_.OptionalHeader.Win32VersionValue;
	Subsystem = nt_headers_.OptionalHeader.Subsystem;
