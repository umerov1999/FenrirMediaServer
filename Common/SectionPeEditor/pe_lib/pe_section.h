...
public:
	...
	section& initializingdata(bool initializingdata);
	section& uninitializingdata(bool uninitializingdata);
	section& code(bool code);
	section& extended_relocation(bool extended_relocation);
	section& not_cached(bool not_cached);
	section& not_paged(bool not_paged);
	...
	bool initializingdata() const;
	bool uninitializingdata() const;
	bool code() const;
	bool extended_relocation() const;
