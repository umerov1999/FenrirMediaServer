...
public:
	...
	XTPMarkupSmoothingMode SetDefaultSmoothingMode(
		XTPMarkupSmoothingMode smoothingMode); // <combine
											   // CXTPMarkupContext::GetDefaultSmoothingMode@const>
	...
	BOOL SetDefaultTextSmoothing(
		BOOL bEnableTextSmoothing); // <combine CXTPMarkupContext::GetDefaultTextSmoothing@const>
	...
	//-----------------------------------------------------------------------
	void SetDelegate(LPCWSTR lpszDelegate, CXTPMarkupDelegate* pDelegate);
