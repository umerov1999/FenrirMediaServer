...
protected:
	...
	CXTPMarkupPoint* GetRenderTransformOrigin() const;
...
public:
	...
	static CXTPMarkupDependencyProperty* m_pRenderTransformProperty; // Gets or sets transform
																	 ...
																	 // element.
	static CXTPMarkupDependencyProperty* m_pRenderTransformOriginProperty; // Gets or sets the
																		   // center point of any
																		   // possible render
																		   // transform declared by
																		   // RenderTransform,
