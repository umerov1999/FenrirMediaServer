...
CXTPMarkupDependencyProperty* CXTPMarkupRenderTransform::m_pPropertyMatrixTransform	= NULL;
...
void CXTPMarkupRenderTransform::RegisterMarkupClass()
{
	...
	m_pPropertyMatrixTransform = CXTPMarkupDependencyProperty::Register(
		L"MatrixTransform", MARKUP_TYPE(CXTPMarkupMatrixTransform),
		MARKUP_TYPE(CXTPMarkupRenderTransform));
}
												 ...
												 CXTPMarkupObject* pContent)
{
	...
	else if (pContent->IsKindOf(MARKUP_TYPE(CXTPMarkupMatrixTransform)))
	{
		SetValue(m_pPropertyMatrixTransform, pContent);
		m_pContentProperty = m_pPropertyMatrixTransform;
		MARKUP_ADDREF(pContent);
	}
	else
	{
