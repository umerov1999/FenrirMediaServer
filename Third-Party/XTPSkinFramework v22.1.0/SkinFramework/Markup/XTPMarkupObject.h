...
#	define DECLARE_MARKUPCLASS(class_name)                                                        \
	...
	public:                                                                                        \
		...
		static CXTPMarkupType* AFX_CDECL Create##class_name##Instance();                           \
		static void AFX_CDECL Destroy##class_name##Instance(CXTPMarkupType* pType);                \
...
#	define IMPLEMENT_MARKUPCLASS(class_tag, class_name, base_class_name)                          \
		...
		CXTPMarkupType* AFX_CDECL class_name::Create##class_name##Instance()                       \
		{                                                                                          \
			CXTPMarkupType* pType = new CXTPMarkupType(class_tag, L#class_name,                    \
		...
		void AFX_CDECL class_name::Destroy##class_name##Instance(CXTPMarkupType* pType)            \
		{                                                                                          \
			ASSERT(NULL != pType);                                                                 \
		...
		{                                                                                          \
			static CXTPThreadLocal<CXTPMarkupType> tlsType(                                        \
				class_name::Create##class_name##Instance,                                          \
				class_name::Destroy##class_name##Instance);                                        \
			return &*tlsType;                                                                      \
		}                                                                                          \
