...
void CXTPSkinObjectClassMap::AddStandardClasses()
{
	...
	AddClass(_T("ComboBoxEx32"), RUNTIME_CLASS_INFO(CXTPSkinObjectComboBox));
	AddClass(_T("Edit"), RUNTIME_CLASS_INFO(CXTPSkinObjectEdit));
	AddClass(_T("MfcEditBrowse"), RUNTIME_CLASS_INFO(CXTPSkinObjectEdit));
	...
	AddSynonymClass(_T("TMfcEditBrowse"), _T("MfcEditBrowse"));
	...
	AddSynonymClass(_T("TComboBoxEx"), _T("ComboBoxEx32"));
