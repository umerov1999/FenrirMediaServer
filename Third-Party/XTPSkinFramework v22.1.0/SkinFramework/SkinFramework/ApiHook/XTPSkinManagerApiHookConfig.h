...
// Uncomment definition of XTP_SKINFRAMEWORK_USE_LEGACY_API_HOOK and re-build ToolkitPro
// in order to use the legacy API hook implementation that has been in place
// prior to introducing the Detours API hooks.
// Refer to the "Microsoft Detours base API hook core for SkinFramework" FAQ article
//  - https://codejock.com/support/articles/mfc/skinframework/detours.asp
