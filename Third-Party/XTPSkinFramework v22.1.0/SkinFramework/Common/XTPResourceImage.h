...
public:
	...
	//-----------------------------------------------------------------------
	int GetHeight() const;
	int GetWidth() const;	// <combine CXTPResourceImage::GetHeight@const>
	CSize GetExtent() const; // <combine CXTPResourceImage::GetHeight@const>
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Enables/disables image flipping.
	// Parameters:
...
//-----------------------------------------------------------------------
// Summary:
//     Call to access members of the CXTPResourceImages class.
// Returns:
//     Returns the a pointer to the single instance of the
...
//-----------------------------------------------------------------------
// Summary:
//     Call to access members of the CXTPResourceImage class.
// Parameters:
//     lpszImageFile - Name of the image file to load specified in the theme INI.
// Returns:
//     Returns the a pointer to the single instance of the
...
//-----------------------------------------------------------------------
// Summary:
//     Call to get the color value specified by lpszKey from the
//     current theme.
// Parameters:
//     lpszSection - Name of the section in the theme INI file.
//     lpszKey     - Name of the value that defines the specified value.
//     clrDef      - Default value returned if lpszKey was not found.
// Returns:
//     A value representing the color defined by lpszKey.
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// Summary:
//     Call to get the int value specified by lpszKey from the
//     current theme.
// Parameters:
//     lpszSection - Name of the section in the theme INI file.
//     lpszKey     - Name of the value that defines the specified value.
...
// Returns:
//     A value representing the int defined by lpszKey.
//-----------------------------------------------------------------------
_XTP_EXT_CLASS int AFX_CDECL XTPIniInt(LPCTSTR lpszSection, LPCTSTR lpszKey, int nDef);

//-----------------------------------------------------------------------
// Summary:
//     Call to get the CRect value specified by lpszKey from the
//     current theme.
// Parameters:
//     lpszSection - Name of the section in the theme INI file.
//     lpszKey     - Name of the value that defines the specified value.
...
// Returns:
//     A value representing the CRect defined by lpszKey.
//-----------------------------------------------------------------------
_XTP_EXT_CLASS CRect AFX_CDECL XTPIniRect(LPCTSTR lpszSection, LPCTSTR lpszKey, CRect rcDef);

//-----------------------------------------------------------------------
// Summary:
//     Call to get the CSize value specified by lpszKey from the
//     current theme.
// Parameters:
//     lpszSection - Name of the section in the theme INI file.
//     lpszKey     - Name of the value that defines the specified value.
...
// Returns:
//     A value representing the CSize defined by lpszKey.
//-----------------------------------------------------------------------
_XTP_EXT_CLASS CSize AFX_CDECL XTPIniSize(LPCTSTR lpszSection, LPCTSTR lpszKey, CSize szDef);

//-----------------------------------------------------------------------
// Summary:
//     Call to get the CString value specified by lpszKey from the
//     current theme.
// Parameters:
//     lpszSection - Name of the section in the theme INI file.
//     lpszKey     - Name of the value that defines the specified value.
...
// Returns:
//     A value representing the CString defined by lpszKey.
//-----------------------------------------------------------------------
...
// VisualStudio2017.dll
#	define xtpIniVisualStudio2017Blue                                                             \
		_T("VISUALSTUDIO2017BLUE_INI") // Specifies Visual Studio 2017 Blue settings file.
#	define xtpIniVisualStudio2017BlueExtra                                                        \
		_T("VISUALSTUDIO2017BLUEEXTRA_INI") // Specifies Visual Studio 2017 Blue Extra settings
											// file.
#	define xtpIniVisualStudio2017Dark                                                             \
		_T("VISUALSTUDIO2017DARK_INI") // Specifies Visual Studio 2017 Dark settings file.
#	define xtpIniVisualStudio2017Light                                                            \
		_T("VISUALSTUDIO2017LIGHT_INI") // Specifies Visual Studio 2017 Light settings file.

// VisualStudio2019.dll
#	define xtpIniVisualStudio2019Blue                                                             \
		_T("VISUALSTUDIO2019BLUE_INI") // Specifies Visual Studio 2019 Blue settings file.
#	define xtpIniVisualStudio2019BlueExtra                                                        \
		_T("VISUALSTUDIO2019BLUEEXTRA_INI") // Specifies Visual Studio 2019 Blue Extra settings
											// file.
#	define xtpIniVisualStudio2019Dark                                                             \
		_T("VISUALSTUDIO2019DARK_INI") // Specifies Visual Studio 2019 Dark settings file.
#	define xtpIniVisualStudio2019Light                                                            \
		_T("VISUALSTUDIO2019LIGHT_INI") // Specifies Visual Studio 2019 Light settings file.

// VisualStudio2022.dll
#	define xtpIniVisualStudio2022Blue                                                             \
		_T("VISUALSTUDIO2022BLUE_INI") // Specifies Visual Studio 2022 Blue settings file.
#	define xtpIniVisualStudio2022BlueExtra                                                        \
		_T("VISUALSTUDIO2022BLUEEXTRA_INI") // Specifies Visual Studio 2022 Blue Extra settings
											// file.
#	define xtpIniVisualStudio2022Dark                                                             \
		_T("VISUALSTUDIO2022DARK_INI") // Specifies Visual Studio 2022 Dark settings file.
#	define xtpIniVisualStudio2022Light                                                            \
		_T("VISUALSTUDIO2022LIGHT_INI") // Specifies Visual Studio 2022 Light settings file.
