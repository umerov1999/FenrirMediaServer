...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the XML/encoded XML representation of the node and all its descendants.
	// Parameters:
	//     bFormatted - TRUE to format XML/encoded XML output
	// Returns:
	//     XML/encoded XML representation of this node and all its descendants.
	//-----------------------------------------------------------------------
	CString GetXML(BOOL bFormatted = FALSE);
	CString GetEncodedXML(BOOL bFormatted = FALSE); // <combine
													// CXTPPropExchangeXMLNode::GetXML@BOOL>
