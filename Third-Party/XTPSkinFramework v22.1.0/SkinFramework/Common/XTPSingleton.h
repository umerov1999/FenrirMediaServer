...
//===========================================================================
// Summary:
//     Implements Singleton design pattern for a pointer of unspecified
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains encapsulated singleton instance pointer. The instance is
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a previously created and allocated instance and
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains reference to singleton access critical secton.
	// Returns:
	//     A reference to singleton access critical secton.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     Implements Singleton design pattern. Can be used both as an
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains encapsulated singleton instance reference. The instance is
...
//===========================================================================
// Summary:
//     Implements Singleton design pattern for a derived class with
