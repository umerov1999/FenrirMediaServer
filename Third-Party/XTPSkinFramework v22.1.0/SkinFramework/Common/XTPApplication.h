...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Triggers ambient property update notification even if property value is not changed.
	// Parameters:
	//     nProperty - Ambient property identifier.
	// See also:
	//     XTPInitialize, XTPGetApplication
	//-----------------------------------------------------------------------
	void TriggerAmbientPropertyUpdate(XTPApplicationAmbientProperty nProperty);
