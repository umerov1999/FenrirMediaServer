...
//===========================================================================
// Summary:
//     CXTPThemeDLL is a helper class used to load Codejock theme
//     resource DLLs.  Use XTPThemeDLL() to access the meembers of
//     this class.
// See Also:
//     XTPThemeDLL()
//===========================================================================
class _XTP_EXT_CLASS CXTPThemeDLL
{
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Default constructor handles initialization.
	//-----------------------------------------------------------------------
	CXTPThemeDLL();
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to load the style DLL's from
	//     the specified path.  If 'lpszDllPath' is NULL then the application
	//     folder + \\Styles path is used as a default.
	// Parameters:
	//     hAppInstance - Instance of application who's path will be used to locate
	//                    the 'Styles' folder.  Can be NULL when using 'lpszDllPath'.
	//     lpszDllPath  - Path where Codejock theme DLL's are located.
	// Returns:
	//     TRUE if one or more of the Codejock theme DLL's were located,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the handle to the resource DLL used for Codejock themes.
	// Parameters:
	//     strINI - Name of the INI file to be loaded from the
	//              resource DLL.
	// Returns:
	//     TRUE if the handle was successfully set, otherwise FALSE.
	// See Also:
	//     See XTPResourceImage.h for a list of constants you can use
	//     for strINI.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Resets all properties of ResourceImages
	//-----------------------------------------------------------------------
	void Reset();
...
private:
	...
	CXTPModuleHandle m_hVisualStudio2017; // Handle to the Visual Studio 2017 theme DLL.
	CXTPModuleHandle m_hVisualStudio2019; // Handle to the Visual Studio 2019 theme DLL.
	CXTPModuleHandle m_hVisualStudio2022; // Handle to the Visual Studio 2022 theme DLL.
...
//===========================================================================
// Summary:
//     XTPThemeDLL returns pointer to common CXTPThemeDLL class
// Returns:
//     Returns pointer to common CXTPThemeDLL class
// See Also:
//     CXTPThemeDLL
//===========================================================================
