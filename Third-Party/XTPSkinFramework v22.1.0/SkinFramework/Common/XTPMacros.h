...
// The macro should be used instead of UNUSED and UNREFERENCED_PARAMETER in order to address
// cross version compatibility issues in Visual Studio
#	define XTP_UNUSED_PARAMETER(name) ((void)(&(name)))

//{{AFX_CODEJOCK_PRIVATE
#	define XTP_VARIANT_TRUE VARIANT_BOOL(-1)
#	define XTP_VARIANT_FALSE VARIANT_BOOL(0)
#	ifndef IS_INTRESOURCE
#		define XTP_IS_INTRESOURCE(x) (((size_t)(x) >> 16) == 0)
#	else
#		define XTP_IS_INTRESOURCE(x) IS_INTRESOURCE(x)
#	endif
//}}AFX_CODEJOCK_PRIVATE
