...
#define MAKELANGINFO(l, s, w, e, c, f)                                                             \
	{                                                                                              \
		MAKELANGID(l, s), w, e, c, _T(#l), _T(#s), f                                               \
	}
...
static XTP_RESOURCEMANAGER_LANGINFO langinfo[] = {
	MAKELANGINFO(LANG_RUSSIAN, SUBLANG_DEFAULT, 1251, _T("windows-1251"), _T("Russian"),
				 RUSSIAN_CHARSET),
	MAKELANGINFO(LANG_JAPANESE, SUBLANG_DEFAULT, 932, _T("shift-jis"), _T("Japanese"),
				 SHIFTJIS_CHARSET),
	MAKELANGINFO(LANG_ARABIC, SUBLANG_ARABIC_SAUDI_ARABIA, 1256, _T("windows-1256"),
				 _T("Arabic (Saudi Arabia)"), ARABIC_CHARSET),
	MAKELANGINFO(LANG_CZECH, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Czech"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_DANISH, SUBLANG_DEFAULT, 1252, _T("windows-1252"), _T("Danish"),
				 ENGLISH_CHARSET),
	MAKELANGINFO(LANG_GERMAN, SUBLANG_GERMAN, 1252, _T("windows-1252"), _T("German (Germany)"),
				 ENGLISH_CHARSET),
	MAKELANGINFO(LANG_GREEK, SUBLANG_DEFAULT, 1253, _T("windows-1253"), _T("Greek"), GREEK_CHARSET),
	MAKELANGINFO(LANG_ENGLISH, SUBLANG_ENGLISH_US, CP_ACP, _T("windows-1252"),
				 _T("English (United States)"), ENGLISH_CHARSET),
	MAKELANGINFO(LANG_SPANISH, SUBLANG_SPANISH_MODERN, 1252, _T("windows-1252"),
				 _T("Spanish (Spain - Modern Sort)"), ENGLISH_CHARSET),
	MAKELANGINFO(LANG_ESTONIAN, SUBLANG_DEFAULT, 1257, _T("windows-1257"), _T("Estonian"),
				 BALTIC_CHARSET),
	MAKELANGINFO(LANG_FINNISH, SUBLANG_DEFAULT, 1252, _T("windows-1252"), _T("Finnish"),
				 ENGLISH_CHARSET),
	MAKELANGINFO(LANG_FRENCH, SUBLANG_FRENCH, 1252, _T("windows-1252"), _T("French (France)"),
				 ENGLISH_CHARSET),
	MAKELANGINFO(LANG_HEBREW, SUBLANG_DEFAULT, 1255, _T("windows-1255"), _T("Hebrew"),
				 HEBREW_CHARSET),
	MAKELANGINFO(LANG_CROATIAN, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Croatian"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_HUNGARIAN, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Hungarian"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_ITALIAN, SUBLANG_ITALIAN, 1252, _T("windows-1252"), _T("Italian (Italy)"),
				 ENGLISH_CHARSET),
	MAKELANGINFO(LANG_KOREAN, SUBLANG_DEFAULT, 949, _T("ks_c_5601"), _T("Korean"), HANGEUL_CHARSET),
	MAKELANGINFO(LANG_LITHUANIAN, SUBLANG_LITHUANIAN, 1257, _T("windows-1257"), _T("Lithuanian"),
				 BALTIC_CHARSET),
	MAKELANGINFO(LANG_LATVIAN, SUBLANG_DEFAULT, 1257, _T("windows-1257"), _T("Latvian"),
				 BALTIC_CHARSET),
	MAKELANGINFO(LANG_DUTCH, SUBLANG_DUTCH, 1252, _T("windows-1252"), _T("Dutch"), ENGLISH_CHARSET),
	MAKELANGINFO(LANG_NORWEGIAN, SUBLANG_NORWEGIAN_BOKMAL, 1252, _T("windows-1252"),
				 _T("Norwegian (Bokmal)"), ENGLISH_CHARSET),
	MAKELANGINFO(LANG_POLISH, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Polish"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_PORTUGUESE, SUBLANG_PORTUGUESE, 1252, _T("windows-1252"),
				 _T("Portuguese (Portugal)"), ENGLISH_CHARSET),
	MAKELANGINFO(LANG_PORTUGUESE, SUBLANG_PORTUGUESE_BRAZILIAN, 1252, _T("windows-1252"),
				 _T("Portuguese (Brazil)"), ENGLISH_CHARSET),
	MAKELANGINFO(LANG_ROMANIAN, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Romanian"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_SERBIAN, SUBLANG_SERBIAN_LATIN, 1250, _T("windows-1250"), _T("Serbian"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_SLOVAK, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Slovak"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_SLOVENIAN, SUBLANG_DEFAULT, 1250, _T("windows-1250"), _T("Slovenian"),
				 EASTEUROPE_CHARSET),
	MAKELANGINFO(LANG_SWEDISH, SUBLANG_DEFAULT, 1252, _T("windows-1252"), _T("Swedish"),
				 ENGLISH_CHARSET),
	MAKELANGINFO(LANG_THAI, SUBLANG_DEFAULT, 874, _T("windows-874"), _T("Thai"), THAI_CHARSET),
	MAKELANGINFO(LANG_TURKISH, SUBLANG_DEFAULT, 1254, _T("windows-1254"), _T("Turkish"),
				 TURKISH_CHARSET),
	MAKELANGINFO(LANG_UKRAINIAN, SUBLANG_DEFAULT, 1251, _T("windows-1251"), _T("Ukrainian "),
				 RUSSIAN_CHARSET),
	MAKELANGINFO(LANG_BULGARIAN, SUBLANG_DEFAULT, 1251, _T("windows-1251"), _T("Bulgarian"),
				 RUSSIAN_CHARSET),
	MAKELANGINFO(LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED, 936, _T("gb2312"), _T("Chinese (PRC)"),
				 GB2312_CHARSET),
	MAKELANGINFO(LANG_CHINESE, SUBLANG_CHINESE_TRADITIONAL, 950, _T("big5"), _T("Chinese (Taiwan)"),
				 CHINESEBIG5_CHARSET)
};
...
{
	CString strExtension = strResourceFile.GetLength() > 3 ? strResourceFile.Right(3) : CString();
	...
	else
	{
		...
		pResourceManager->m_hResourceFile = strResourceFile.IsEmpty()
												? 0
												: LoadLibrary(strResourceFile);
...
{
	return bTryParse ? 0 != MakeIntResource(lpName) : XTP_IS_INTRESOURCE(lpName);
}
										  ...
										  LONG_PTR lParam)
{
	...
	::EnumResourceLanguages(hModule, lpszType, lpszName, &CXTPResourceManager::EnumResLangProc,
							lParam);
...
BOOL CXTPResourceManager::EnumResLangProc(HMODULE hModule, LPCTSTR lpszType, LPCTSTR lpszName,
...
BOOL CXTPResourceManager::OnLoadingFailed()
{
	return FALSE;
}
...
void CXTPResourceManager::AssertValid(BOOL bValid)
{
	if (!bValid)
	{
		XTP_ERROR_MSG("Error Locating Toolkit Resources.\n\n"
...
BOOL CXTPResourceManager::LoadString(CString* pString, UINT nIDResource)
{
	...
	if (hResourceInstanse
		&& ::FindResource(hResourceInstanse, MAKEINTRESOURCE((nIDResource >> 4) + 1), RT_STRING))
	{
...
BOOL CXTPResourceManager::LoadMenu(CMenu* lpMenu, UINT nIDResource)
{
	...
	if (hResourceInstanse
		&& ::FindResource(hResourceInstanse, MAKEINTRESOURCE(nIDResource), RT_MENU))
	{
...
HCURSOR CXTPResourceManager::LoadCursor(UINT nIDResource)
{
	...
	if (hResourceInstanse
		&& ::FindResource(hResourceInstanse, MAKEINTRESOURCE(nIDResource), RT_GROUP_CURSOR))
	{
...
HGLOBAL CXTPResourceManager::LoadDialogTemplate2(LPCTSTR pszTemplate)
{
	...
	HRSRC hResource = hResourceInstanse ? FindResource(hResourceInstanse, pszTemplate, RT_DIALOG)
										: NULL;

	if (hResource == NULL)
	{
		hResourceInstanse = AfxFindResourceHandle(pszTemplate, RT_DIALOG);
		hResource = hResourceInstanse ? FindResource(hResourceInstanse, pszTemplate, RT_DIALOG)
									  : NULL;
	}
...
#ifdef _UNICODE
	int nLen = ::MultiByteToWideChar(CP_ACP, 0, (LPCSTR)pSrc, XTPToIntChecked(dwSize), pDst,
									 XTPToIntChecked(dwDstSize));
#else
...
BOOL CXTPResourceManager::LoadXAML(CString& xaml, UINT nIDResource)
{
	HMODULE hResourceInstance = GetResourceHandle();

	HRSRC hRsrc = ::FindResource(hResourceInstance, MAKEINTRESOURCE(nIDResource), _T("RT_XAML"));
	if (NULL == hRsrc)
	{
		hResourceInstance = AfxFindResourceHandle(MAKEINTRESOURCE(nIDResource), _T("RT_XAML"));
		if (hResourceInstance == NULL)
			return FALSE;

		hRsrc = ::FindResource(hResourceInstance, MAKEINTRESOURCE(nIDResource), _T("RT_XAML"));
	}

	HGLOBAL hGlobal = ::LoadResource(hResourceInstance, hRsrc);
	if (NULL == hGlobal)
		return FALSE;
	...
	DWORD dwSize = ::SizeofResource(hResourceInstance, hRsrc);
	if (0 == dwSize)
	{
	...
	CArray<WCHAR, WCHAR> pBuffer;
	UINT ccBuffer = dwSize + 1;
	pBuffer.SetSize(XTPToIntPtrChecked(ccBuffer));

	BOOL res = XTPLoadUnicodeText(pData, dwSize, pBuffer.GetData(), &ccBuffer);
	if (res)
	{
		xaml = XTP_CW2CT(pBuffer.GetData());
	}
...
HICON CXTPResourceManager::CreateIconFromResource(HMODULE hModule, LPCTSTR lpszID, CSize iconSize)
{
	...
	HRSRC hResource = ::FindResource(hModule, lpszID, RT_GROUP_ICON);
	...
	int nID = ::LookupIconIdFromDirectoryEx((PBYTE)lpResource, TRUE, iconSize.cx, iconSize.cy,
											LR_DEFAULTCOLOR);
...
{
	if (m_pLanguageInfo
		&& (m_pLanguageInfo->nCodePage == 1256
			|| m_pLanguageInfo->nCodePage == 1255)) // Arabic or Hebrew ?
		nType |= MB_RTLREADING;
...
int CXTPResourceManager::GetMenuLocaleString(CMenu* pMenu, UINT nIDItem, CString& rString,
											 UINT nFlags) const
{
	...
	if (nStringLen > 0)
	{
		...
		if (XTPSystemVersion()->IsWin2KOrGreater())
		{
			...
			int nDestLen = WideCharToMultiByte(m_pLanguageInfo->nCodePage, 0, lpwstr, nStringLen,
											   NULL, 0, NULL, NULL);
			LPTSTR pstrString = rString.GetBufferSetLength(nDestLen);

			WideCharToMultiByte(m_pLanguageInfo->nCodePage, 0, lpwstr, nStringLen, pstrString,
								nDestLen, NULL, NULL);
...
int CXTPResourceManager::LoadLocaleString(HINSTANCE hInstance, UINT nID, CString& rString) const
{
	...
	int nDestLen   = WideCharToMultiByte(nCodePage, 0, (LPWSTR)(pImage + 1), nLength, NULL, 0, NULL,
										 NULL);
...
public:
	...
	UINT GetLength() const
	{
		return AlignDWord(sizeof(DLGITEMTEMPLATEEX)
						  + ((nCaptionID != 0 ? 1 : (int)wcslen(lpszCaption)) * sizeof(WORD))
						  + sizeof(WORD) + strClassName.GetLength() * sizeof(WORD) + sizeof(WORD)
						  + 0 + sizeof(WORD));
	}
};
...
public:
	...
	{
		return AlignDWord(sizeof(DLGTEMPLATEEX) + sizeof(WORD) + sizeof(WORD)
						  + ((int)wcslen(lpszCaption) * sizeof(WORD) + sizeof(WORD))
						  + (style & DS_SETFONT
								 ? strFaceName.GetLength() * sizeof(WORD) + sizeof(WORD)
...
void CXTPResourceManagerXML::AddMenuItems(CXTPPropExchange* pPX, MENUTEMPLATEINFO* pItems)
{
	...
	while (pos)
	{
		...
		PX_Bstr(&sec, _T("caption"), pItemInfo->lpszCaption, _bstr_t(L""));
...
BOOL CXTPResourceManagerXML::CreateMenu(CMenu& menu, CXTPPropExchange* pPX)
{
	...
	MENUITEMTEMPLATE* mitem = (MENUITEMTEMPLATE*)((BYTE*)lpDlgTemplate
	...
	for (int i = 0; i < menuTemplate.aItems.GetSize(); i++)
	{
		...
		{
			MEMCPY_S((BYTE*)mitem + sizeof(mitem->mtOption), itemInfo.lpszCaption,
					 (wcslen(itemInfo.lpszCaption) + 1) * sizeof(WORD));
		}
		else
		{
			mitem->mtID = itemInfo.mtID;
			MEMCPY_S(mitem->mtString, itemInfo.lpszCaption,
					 (wcslen(itemInfo.lpszCaption) + 1) * sizeof(WORD));
		}
...
LPDLGTEMPLATE CXTPResourceManagerXML::CreateDialogTemplate(CXTPPropExchange* pPX)
{
	...
	PX_Bstr(pPX, _T("caption"), dlgTemplate.lpszCaption, _bstr_t(L""));
...
#	define RES_TYPE_ENTRY(ext, type) { ext, _countof(ext) - 1, type }
		RES_TYPE_ENTRY(_T(".png"), _T("PNG")), RES_TYPE_ENTRY(_T(".bmp"), RT_BITMAP),
		RES_TYPE_ENTRY(_T(".ico"), RT_ICON),   RES_TYPE_ENTRY(_T(".htm"), RT_HTML),
		RES_TYPE_ENTRY(_T(".html"), RT_HTML),  RES_TYPE_ENTRY(_T(".js"), _T("JS")),
...
static BOOL CALLBACK FindResourceTypeEnumProc(HMODULE hModule, LPTSTR lpType, LONG_PTR lParam)
{
