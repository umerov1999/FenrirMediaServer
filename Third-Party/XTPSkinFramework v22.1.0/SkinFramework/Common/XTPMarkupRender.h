...
// See Also:
//     XTPMarkupReleaseContext, XTPMarkupParseText, XTPMarkupReleaseElement
//-----------------------------------------------------------------------
...
//     See Example for XTPMarkupCreateContext function
// See Also:
//     XTPMarkupCreateContext, XTPMarkupReleaseElement, XTPMarkupMeasureElement,
//     XTPMarkupRenderElement
//-----------------------------------------------------------------------
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL XTPMarkupParseText(CXTPMarkupContext* pContext,
																 LPCSTR lpszMarkup);
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL XTPMarkupParseText(
	CXTPMarkupContext* pContext,
	LPCWSTR lpszMarkup); // <combine XTPMarkupParseText@CXTPMarkupContext*@LPCSTR>
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL
	XTPMarkupParseText(CXTPMarkupContext* pContext, LPCSTR lpszMarkup,
					   INT_PTR nLength); // <combine XTPMarkupParseText@CXTPMarkupContext*@LPCSTR>
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL
	XTPMarkupParseText(CXTPMarkupContext* pContext, LPCWSTR lpszMarkup,
					   INT_PTR nLength); // <combine XTPMarkupParseText@CXTPMarkupContext*@LPCSTR>
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL
	XTPMarkupParseText(CXTPMarkupContext* pContext,
					   IStream* pStream); // <combine XTPMarkupParseText@CXTPMarkupContext*@LPCSTR>
...
//     See Example for XTPMarkupCreateContext function
// See Also:
//     XTPMarkupCreateContext, XTPMarkupParseText, XTPMarkupMeasureElement,
//     XTPMarkupRenderElement
//-----------------------------------------------------------------------
...
// See Also:
//     XTPMarkupCreateContext, XTPMarkupParseText, XTPMarkupRenderElement
//-----------------------------------------------------------------------
...
_XTP_EXT_CLASS BOOL AFX_CDECL XTPMarkupRelayMessage(
	CXTPMarkupContext* pContext, UINT message, WPARAM wParam, LPARAM lParam,
	LRESULT* pResult); // <combine
					   // XTPMarkupRelayMessage@CXTPMarkupUIElement*@UINT@WPARAM@LPARAM@LRESULT*>
