...
//===========================================================================
// Summary:
//     Wrapper around scriptable object.
//===========================================================================
...
private:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs scriptable object context.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Handles scriptable object context deallocation.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Increments context reference count.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Decrements context reference count.
	// Returns:
	//     Current number of references.
	//-----------------------------------------------------------------------
	ULONG Release();
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains parent scripting engine instance pointer.
	// Returns:
	//     A pointer to a CXTPActiveScriptEngine object.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Invokes a function object with no arguments.
	// Parameters:
	//     pvtResult - Optional pointer to value that revceives a value returned
	//                 from function.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Invokes a function object with 1 argument.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains context object's property or function.
	// Parameters:
	//     lpszName - Name of object's property or function.
	// Returns:
	//     A pointer to new context object or NULL if failed.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     Implements ActiveScript engine component.
//===========================================================================
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs scripting engine object.
	//-----------------------------------------------------------------------
	CXTPActiveScriptEngine();

	//-----------------------------------------------------------------------
	// Summary:
	//     Handles scripting engine deallocation.
	//-----------------------------------------------------------------------
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Uninitializes scripting engine.
	//-----------------------------------------------------------------------
	void Uninitialize();

	//-----------------------------------------------------------------------
	// Summary:
	//     Loads a chunk of code into execution context. Number of
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains global object's context instance.
	// Returns:
	//     Global object's context instance pointer or NULL if failed.
	//-----------------------------------------------------------------------
	CXTPActiveScriptObjectContext* GetGlobalContext() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Information about the last unhandled exception.
	// Returns:
	//     The last unhandled exception pointer or NULL.
	//-----------------------------------------------------------------------
	const EXCEPINFO* GetExceptionInfo() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Adds named item name and data into execution context.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains data pointer associated with named item.
	// Parameters:
	//     lpszName - Item name pointer.
	// Returns:
	//     Item data pointer value or NULL if not specified.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     Implements standard scripting runtime library.
//===========================================================================
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs scripting runtime library.
	//-----------------------------------------------------------------------
	CXTPActiveScriptStdRuntime();

	//-----------------------------------------------------------------------
	// Summary:
	//     Handles standard scripting runtime library deallocation.
	//-----------------------------------------------------------------------
	~CXTPActiveScriptStdRuntime();
