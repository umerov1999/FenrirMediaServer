...
//---------------------------------------------------------------------------
// Summary:
//     Defines a base ID for common notifications.
//---------------------------------------------------------------------------
...
// See Also:
//     CXTPNotifySinkBase overview, CXTPNotifyConnection overview
//===========================================================================
...
public:
	...
	// See Also:
	//     CXTPNotifySinkBase overview, Unadvise() method.
	//-----------------------------------------------------------------------
...
protected:
	...
	// See Also:
	//     Advise method, CONNECTION_DESCRIPTOR
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CCriticalSection, CSingleLock, CSyncObject.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPNotifyConnection overview, CXTPNotifySinkBase overview
	//===========================================================================
	...
	public:
		...
		//     TRUE
		// See Also:
		//     CCriticalSection::Lock, CSingleLock, CSyncObject.
		//-----------------------------------------------------------------------
		...
		//     TRUE
		// See Also:
		//     CCriticalSection::Unlock, CSingleLock, CSyncObject.
		//-----------------------------------------------------------------------
		virtual BOOL Unlock();
		virtual BOOL Unlock(
			LONG lCount,
...
//     potential errors with intersected NotificationCodes.
// See Also:
//     CXTPNotifySinkBase, CXTPNotifyConnection
//===========================================================================
...
public:
	...
	//     FALSE - otherwise.
	// See Also:
	//     Advise(), SendEvent(), XTPNotifyFlags
	//-----------------------------------------------------------------------
...
//     potential errors with intersected NotificationCodes.
// See Also:
//     CXTPNotifySinkBase overview, DECLARE_XTPSINK macro,
...
public:
	...
	//     CXTPNotifyConnection, CXTPNotifyConnection::Advise method
	//-----------------------------------------------------------------------
...
public:
	...
	// See Also:
	//     CXTPNotifySinkBase, UnadviseAll method, Advise method,
	//     CXTPNotifyConnection, CXTPNotifyConnection::Unadvise method
	//-----------------------------------------------------------------------
	void UnadviseAll();
...
protected:
	...
	//     The unique connection ID used for Unadvise() method.
	// See Also:
	//     CXTPNotifySinkBase, Unadvise method, GetParam method,
	//     CXTPNotifyConnection, CXTPNotifyConnection::Advise method
	//-----------------------------------------------------------------------
...
{
	return new CXTPNotifySinkClassDelegate<T>(
		pClass, (typename CXTPNotifySinkClassDelegate<T>::EVENTHANDLER)pfnDelegate);
}
