...
//              known MSXML class version but not lower than XTP default MSXML class version.
//     pClsid - Specified exact or the least acceptable MSXML class version value.
//              If no class ID is provided, then the XTP default MSXML class id will be used.
//     fEnableProps - A set of XTPXmlDomProperties flags for properties to be explicitly enabled
//			          regardless their default value. The default values are set for the best
// performance 			          and security.
//     fDisableProps - A set of XTPXmlDomProperties flags for properties to be explicitly disabled
//				       regardless their default value. The default values are set for the best
// performance 				       and security. xtpXmlDomUseXPath and xtpXmlDomUseXSLPattern cannot
// be disabled 				       so they are ignored. Returns:
