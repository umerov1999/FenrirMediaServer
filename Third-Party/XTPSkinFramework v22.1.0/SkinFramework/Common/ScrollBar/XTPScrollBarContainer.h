...
public:
	...
	void SetScrollBarClass(CRuntimeClass* pClass = NULL);
...
private:
	...
	CRuntimeClass* m_pScrollBarClass;
};
//}}AFX_CODEJOCK_PRIVATE
...
public:
	...
	// -----------------------------------------------------------------
	// Summary: Sets a scroll bar class to be used for creating scroll bars.
	// Parameters:
	// 	   pClass - A scroll bar class pointer. The class must be derived
	// 	            from CXTPScrollBarCtrl. NULL indicates CXTPScrollBarCtrl
	// 	            to be used by default.
	// -----------------------------------------------------------------
	void SetScrollBarClass(CRuntimeClass* pClass = NULL)
	{
		m_Impl.SetScrollBarClass(pClass);
	}
