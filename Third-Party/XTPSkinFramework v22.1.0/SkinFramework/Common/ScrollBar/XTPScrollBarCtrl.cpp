...
IMPLEMENT_DYNCREATE(CXTPScrollBarCtrl, CScrollBar)
...
void CXTPScrollBarCtrl::SetTheme(XTPScrollBarTheme theme)
{
	...
	switch (theme)
	{
		...
		case xtpScrollBarThemeResource: m_pPaintManager = new CXTPScrollBarThemeResource(); break;
		...
		case xtpScrollBarThemeOfficeXP: m_pPaintManager = new CXTPScrollBarThemeOfficeXP(); break;
		...
		case xtpScrollBarThemeVisualStudio2017:
			m_pPaintManager  = new CXTPScrollBarThemeVisualStudio2017();
			m_scrollBarStyle = xtpScrollStyleVisualStudio2017;
			break;

		case xtpScrollBarThemeVisualStudio2019:
			m_pPaintManager  = new CXTPScrollBarThemeVisualStudio2019();
			m_scrollBarStyle = xtpScrollStyleVisualStudio2019;
			break;

		case xtpScrollBarThemeVisualStudio2022:
			m_pPaintManager  = new CXTPScrollBarThemeVisualStudio2022();
			m_scrollBarStyle = xtpScrollStyleVisualStudio2022;
			break;

		case xtpScrollBarThemeNativeWindows10:
			m_pPaintManager  = new CXTPScrollBarThemeNativeWindows10();
			m_scrollBarStyle = xtpScrollStyleNativeWindows10;
			break;
		...
		default: m_pPaintManager = new CXTPScrollBarThemeWindowsUx(); break;
	}
...
void CXTPScrollBarCtrl::DoScroll(int cmd, int pos)
{
	if (!m_spi.fSizebox)
	{
		GetParent()->SendMessage(XTPToUInt(m_spi.fVert ? WM_VSCROLL : WM_HSCROLL),
								 XTPToWPARAM(MAKELONG(cmd, pos)), reinterpret_cast<LPARAM>(m_hWnd));
	}
}
