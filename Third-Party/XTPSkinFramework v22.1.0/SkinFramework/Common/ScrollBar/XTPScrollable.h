...
//	   the default implementation of this interface by CXTPScrollable does not work.
// See also:
//	   CXTPScrollable
//=======================================================================
struct IXTPScrollable
{
	...
	//-----------------------------------------------------------------------
	// Summary:
	//	   Returns TRUE if the control has vertical scroll bar for the combination of styles
	// specified.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//	   Returns TRUE if the control has vertical scroll bar on the left side for the combination
	// of
	//     styles specified.
	// Parameters:
	//	   dwStyle - Window style bits.
	//	   dwExStyle - Window extended style bits.
	// Returns:
	//	   TRUE if the control has vertical scroll bar on the left side for the combination of
	// styles
	...
	//-----------------------------------------------------------------------
	// Summary:
	//	   Disables/removes standard scroll bars so that custom scroll bars created via this
	// interface
	//     could be used.
	// Parameters:
...
#	endif
	...
	// Parameters:
	//	   lpszClassName  - Pointer to a null-terminated string that contains the name of a
	// registered
	//                      system window class; or the name of a predefined system window class.
	//	   lpszWindowName - Pointer to a null-terminated string that contains the window display
	// name;
	//                      otherwise NULL for no window display name.
	//	   dwStyle        - Bitwise combination (OR) of window styles. The WS_POPUP option is not a
	// valid
	//                      style.
	//	   rect           - The size and location of the window relative to the top-left corner of
	// the parent
	//                      window.
	//	   pParentWnd     - Pointer to the parent window.
	//	   nID            - ID of the window.
	//	   pContext       - Pointer to a CCreateContext structure that is used to customize the
	// document-view
	...
	//	   Creates a scrollable control window.
	// Parameters:
	//	   dwExStyle      - Bitwise combination(OR) of extended window styles; otherwise NULL for
	// the
	...
	// valid
	//                      style.
	//	   x              - The initial horizontal distance of the window from the left side of the
	// screen or the
	//                      parent window.
	//	   y              - The initial vertical distance of the window from the top of the screen
	// or the parent
	//                      window.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//	   Performs one time custom scroll bars intitialization. In most common use cases there is
	// no need to
	//     call it manually as intitialization is performed automatically on window creation or DDX
	//     binding.
	// Returns:
