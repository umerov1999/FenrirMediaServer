...
TYPEDEF_WRAPPER_POINTER(30, HRESULT, GetThemeFont)(HTHEME, HDC, int, int, int, LOGFONTW*);
...
public:
	...
	//     Returns S_OK if successful, or an error value otherwise.
	//-----------------------------------------------------------------------
	HRESULT GetThemeFont(HDC hDC, int iPartID, int iStateID, int iPropID, LOGFONTW* pFont);
	...
	// Parameters:
	//     hdcTarget    - Handle of the target device context (DC) on which
	//                    the buffer will be painted.
	//     prcTarget    - Pointer to a RECT structure that specifies the area
	//                    of the target DC in which to paint.
	//     dwFormat     - A member of the BP_BUFFERFORMAT enumeration that
	//                    specifies the format of the buffer.
	//     pPaintParams - [in] Pointer to a BP_PAINTPARAMS structure that
	//                    defines the paint operation parameters. This value
	//                    can be NULL.
	//     phdc         - [out] When this function returns, this value points
	//                    to the handle of the new device context.
	// Returns:
	//     A handle to the buffered paint context
	// See Also:
	//     EndBufferedPaint
	//-----------------------------------------------------------------------
