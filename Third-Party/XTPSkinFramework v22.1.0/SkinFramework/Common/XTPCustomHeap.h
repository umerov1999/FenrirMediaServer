...
public:
	...
	using _TData::ms_bLFHEnabled;
	using _TData::ms_bUseCustomHeap;
	using _TData::ms_dwRefs;
	using _TData::ms_hCustomHeap;
	//}}AFX_CODEJOCK_PRIVATE
...
{
	using _TBatchAllocData::m_bDestroyEmptyBlocksOnFree;
	using _TBatchAllocData::m_bDestroyLastEmptyBlockOnFree;
	using _TBatchAllocData::m_dwAllocatedObjects;
	using _TBatchAllocData::m_nBlockSize;
	using _TBatchAllocData::m_pBusyBlocks;
	using _TBatchAllocData::m_pFreeBlocks;
...
//  class CBatchGridRecord : public CXTPBatchAllocObjT<CXTPGridRecord, CBatchGridRecord_Data>
//  {
//      // ...
//  };
//
