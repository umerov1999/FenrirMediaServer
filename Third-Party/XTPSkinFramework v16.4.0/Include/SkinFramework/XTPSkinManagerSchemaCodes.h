...
static const struct TMS_SCHEMA_ENTRY classAndPartsCodes[] =
{
	// CJ
	_T("Globals"),          1,
	_T("Documentation"),    2,
...
static const struct TMS_SCHEMA_ENTRY enumCodes[] =
{
...
static const struct TMS_SCHEMA_ENTRY stateCodes[] =
{
	_T("FRAME_ACTIVE"),     1,
	_T("FRAME_INACTIVE"),   2,
...
static const struct TMS_SCHEMA_ENTRY propertyCodes[] =
{
...
static int number_for_entry(const TMS_SCHEMA_ENTRY *pArray, LPCTSTR key, LPCTSTR prefix = NULL)
{
...
static int number_for_entry2(const TMS_SCHEMA_ENTRY *pArray, LPCTSTR key, LPCTSTR key2)
{
