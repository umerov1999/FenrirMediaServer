...
#define XTP_MARKUP_STRING_CONSTANT(Name) g_xtpMarkString##Name
#define XTP_DECLARE_MARKUP_STRING_CONSTANT(Name)                                                   \
	static const CXTPMarkupString XTP_MARKUP_STRING_CONSTANT(                                      \
		Name)(XTP_WIDE(#Name), _countof(XTP_WIDE(#Name)) - 1, CXTPMarkupObject::flagNoCom);
