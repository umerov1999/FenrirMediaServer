...
AFX_INLINE const CXTPPaintManagerColor&
	CXTPPaintManagerColor::operator=(const CXTPPaintManagerColor& clr)
{
...
public:
	...
	// Handles object destruction
	//-----------------------------------------------------------------------
	virtual ~CXTPPaintManagerColorGradient()
	{
	}
...
AFX_INLINE const CXTPPaintManagerColorGradient&
	CXTPPaintManagerColorGradient::operator=(const CXTPPaintManagerColorGradient& refSrc)
{
...
public:
	...
	CXTPPaintManagerColorGradient grcMenuExpanded;	// Office 2003 Expanded menu sidebar gradient
													// color.
	CXTPPaintManagerColorGradient grcMenuItemPopup; // Office 2003 Menu item pop-up gradient color.
