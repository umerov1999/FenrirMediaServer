...
CXTPPropExchangeArchive::CSelfArchive::CSelfArchive(CFile* pFile, UINT nMode,
...
BOOL CXTPPropExchangeArchive::ExchangeRuntimeClass(LPCTSTR /*pszPropName*/, CRuntimeClass*& pClass,
...
BOOL CXTPPropExchangeArchive::ExchangeObjectInstance(CObject*& pObject,
...
BOOL CXTPPropExchangeArchive::ExchangeProp(LPCTSTR /*pszPropName*/, VARTYPE vtProp, void* pvProp,
										   const void* pvDefault)
{
	...
	if (m_bLoading)
	{
		switch (vtProp)
		{
			case VT_UI1: m_ar >> *(BYTE*)pvProp; break;
			case VT_I2: m_ar >> *(WORD*)pvProp; break;
			case VT_I4: m_ar >> *(long*)pvProp; break;
			case VT_BOOL: m_ar >> *(BOOL*)pvProp; break;
			case VT_BSTR: ASSERT(FALSE); break;
			case VT_LPSTR: m_ar >> *(CString*)pvProp; break;
			case VT_CY:
				m_ar >> ((CY*)pvProp)->Lo;
				m_ar >> ((CY*)pvProp)->Hi;
				break;
			case VT_R4: m_ar >> *(float*)pvProp; break;
			case VT_R8: m_ar >> *(double*)pvProp; break;
			case VT_EX_RECT: m_ar >> *(RECT*)pvProp; break;
			case VT_EX_SIZE: m_ar >> *(SIZE*)pvProp; break;
			case VT_VARIANT: ::operator>>(m_ar, *(COleVariant*)pvProp); break;
			case VT_DATE: ::operator>>(m_ar, *(COleDateTime*)pvProp); break;
		}
	}
	else
	{
