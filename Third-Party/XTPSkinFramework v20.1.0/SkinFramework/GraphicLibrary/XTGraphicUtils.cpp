...
// this function used a bit long way of creating Gdiplus::Bitmap from Gdiplus::GpBitmap, but found
// no other way to create Gdiplus::Bitmap from Gdiplus::GpBitmap

Gdiplus::Status AFX_CDECL
	CXTPGraphicUtils::GdipCreateBitmapFromHICON_Fixed(HICON hicon, Gdiplus::Bitmap** bitmap)
{
...
Gdiplus::Status AFX_CDECL CXTPGraphicUtils::GdipCreateBitmapFromHICON_Fixed_Native(
	HICON hicon, Gdiplus::GpBitmap** bitmap)
{
	...
	do
	{
		...
		pbBitmapBits = (BYTE*)HeapAlloc(GetProcessHeap(), 0, XTPToSizeTChecked(4 * width * height));
		...
		stat = DllExports::GdipCreateBitmapFromScan0(width, height, 0, PixelFormat32bppARGB, NULL,
													 bitmap);
		...
		stat = DllExports::GdipBitmapLockBits(*bitmap, &rect, Gdiplus::ImageLockModeWrite,
