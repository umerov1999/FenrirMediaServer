...
private:
	static CMap<HTHEME, HTHEME, CXTPSkinManagerClass*, CXTPSkinManagerClass*> m_themeClasses;
};
...
struct IXTPSkinManagerWindowFilter
{
	...
	//     lpcs          - Pointer to the window's CREATESTRUCT structure.
	// Returns:
	//     TRUE if the window will be filtered out, otherwise FALSE (default).
	//-----------------------------------------------------------------------
