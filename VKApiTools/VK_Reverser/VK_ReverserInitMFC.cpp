...
VK_ReverserDialog dlgS;

void VK_Reverser::LoadFont()
{
	DWORD CountUU = 0;
...
void VK_Reverser::CreateDialogMFC()
{
	m_pMainWnd = &dlgS;
	dlgS.DoModal();
}

void VK_Reverser::LoadStyle()
{
...
BEGIN_MESSAGE_MAP(VK_Reverser, CXTPWinApp)

END_MESSAGE_MAP()

VK_Reverser theApp;

BOOL VK_Reverser::InitInstance()
{
